                    ...
                    <div className="col-md-8">
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          {" "}
                          Hair Color: {store.onePeople.hair_color}
                        </p>
                        <p className="card-text">
                          Skin Color: {store.onePeople.skin_color}
                        </p>
                      ...
                      <div className="card-body">
                        ...
                        <div className="btn-group-vertical justify-content-center">
                          ...
                          <button
                            ...
                            onClick={() =>
                              actions.updateFavorites(planets.name)
                            }
                          >
                            Add to Favourites
                            <i
                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-md-8">
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          Model: {store.oneVehicle.model}
                        </p>
                        <p className="card-text">
                          Vehicle class: {store.oneVehicle.vehicle_class}
                        </p>
                        <p className="card-text">
                        ...
                        <div className="btn-group-vertical justify-content-center">
                          ...
                          <button
                            ...
                            onClick={() =>
                              actions.updateFavorites(vehicles.name)
                            }
                          >
                            Add to Favourites
                            <i
